...
### Stoichiometry hydrochemographs
...
We have good data to create hydrochemographs for ammonium, nitrate, TDN, DON, IN, TDP, and DOP. Here is the nitrate hydrochemograph:
```{r}
p4
```
